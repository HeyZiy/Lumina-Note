...
export default {
  ...
  sidebar: {
    ...
    openClawPathNotFound: '{label} 路徑不存在',
    openClawFocusPathError: '無法定位到 {label}',
    openClawFocusPathSuccess: '已定位到 {label}',
    openClawNoPathsToSearch: '沒有可搜尋的路徑：{label}',
    openClawSearchError: '搜尋 {label} 失敗',
    openClawSearchOpened: '已打開 {label} 搜尋',
    openClawPathOutsideWorkspace: '{label} 不在目前工作區內',
    openClawActionSuccessTitle: '操作完成',
  ...
  overview: {
    ...
    openClawSearchPlans: '查看 plans',
    openClawSearchArtifacts: '查看 artifacts',
    openClawFileNotFound: '文件不存在：{file}',
    openClawOpenFileError: '無法打開文件：{file}',
    openClawNoWorkspace: '工作區路徑為空',
    openClawTodayMemoryError: '無法創建或打開今日 memory',
    openClawNoPathsToSearch: '沒有可搜索的路徑：{label}',
    openClawSearchError: '搜索 {label} 失敗',
  },
  ...
  plugins: {
    ...
    safeModeHint: '開啟後將停用所有外觀/主題插件，用於排查介面異常或恢復預設外觀',
    ...
    openWorkspaceFolderHint: '在檔案管理員中開啟預設插件目錄',
