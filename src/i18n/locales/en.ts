...
export default {
  ...
  sidebar: {
    ...
    openClawPathNotFound: '{label} path not found',
    openClawFocusPathError: 'Failed to focus {label}',
    openClawFocusPathSuccess: 'Focused {label}',
    openClawNoPathsToSearch: 'No paths to search for {label}',
    openClawSearchError: 'Failed to search {label}',
    openClawSearchOpened: 'Opened search for {label}',
    openClawPathOutsideWorkspace: '{label} is outside the current workspace',
    openClawActionSuccessTitle: 'Action completed',
  ...
  overview: {
    ...
    openClawDesc: 'Lumina is using the same OpenClaw files. {count} artifact files detected.',
    ...
    openClawSearchPlans: 'View plans',
    openClawSearchArtifacts: 'View artifacts',
    openClawFileNotFound: 'File not found: {file}',
    openClawOpenFileError: 'Failed to open file: {file}',
    openClawNoWorkspace: 'Workspace path is empty',
    openClawTodayMemoryError: 'Failed to create or open today memory',
    openClawNoPathsToSearch: 'No paths to search for {label}',
    openClawSearchError: 'Failed to search {label}',
  },
  ...
  editor: {
    ...
    videoNoteDetected: 'This note looks like a video note. Open it in Video Note to watch and edit side by side.',
  ...
  ai: {
    ...
    agentQueueWaitingApprovalHint: 'Approve or reject the pending tool call first.',
    ...
    skillsManagerDesc: 'View and refresh skills from your workspace, user folder, and built-in library.',
    ...
    welcomeSubtitle: 'I can help you manage notes, organize ideas, and search your knowledge.',
    ...
    agentModeHint: 'Agent mode can read and edit files, then run tasks for you.',
    notConfigured: 'Not configured',
    aiChatSettings: 'AI Chat Settings',
    getRealtimeContent: 'Uses your workspace as live context',
    aiGeneratedWarning: 'AI can make mistakes. Please verify important details.',
  ...
  file: {
    ...
    voiceRecordHint: 'Record a voice note. Lumina saves it and creates a summary when you finish.',
  ...
  plugins: {
    ...
    title: 'Plugins',
    intro: 'Lumina prefers the default plugin folder near the installation location, and also supports workspace .lumina/plugins, user plugin directory, and bundled resources.',
    safeModeOn: 'Appearance Safe Mode: ON',
    safeModeOff: 'Appearance Safe Mode: OFF',
    safeModeHint: 'Disables all appearance/theme plugins. Use to troubleshoot UI issues or restore default appearance.',
    safeModeAffected: 'Affected plugins ({count})',
    unloadStyles: 'Unload All Plugin Styles',
    unloadStylesHint: 'Clear all injected plugin CSS styles without changing plugin enabled state',
    ...
    noPluginsFound: 'No plugins found yet. Create a sample plugin to get started.',
    sourceGlobal: 'Global',
  ...
  database: {
    ...
    calendar: {
      ...
      rescheduleError: 'Failed to update date. Drop again or edit date in table.',
      more: 'more',
    },
  },
  ...
  settingsPanel: {
    ...
    thinkingModeHint: 'One unified switch across models. Unsupported models safely ignore this option.',
  ...
  settingsModal: {
    ...
    mobileGatewayDesc: 'Pair a phone on the same Wi-Fi to send tasks and follow agent output.',
    ...
    openClawTitle: 'OpenClaw Workspace',
    openClawDesc: 'Attach an external OpenClaw workspace so Lumina and OpenClaw work on the same files.',
    ...
    openClawNoWorkspace: 'Open a local workspace first, then check whether it is an OpenClaw workspace.',
    openClawDetected: 'Detected',
    openClawNotDetected: 'Not detected',
    openClawError: 'Detection error',
    openClawAttached: 'Attached',
    openClawRescan: 'Rescan',
    openClawCheckedAt: 'Checked at {time}',
    openClawWorkspacePath: 'Workspace path',
    openClawMountedWorkspace: 'Mounted OpenClaw workspace',
    openClawMountedWorkspacePlaceholder: '/Users/name/.openclaw/workspace',
    openClawMountedWorkspaceHint: 'Choose the external OpenClaw workspace path to attach to this Lumina workspace.',
    ...
    openClawArtifactDirs: 'Artifact directories',
    openClawBoundary: 'Edit boundary',
    openClawBoundaryHint: 'Changes you make in Lumina update the same files OpenClaw uses. This is a live attachment, not an imported copy.',
    openClawGatewayTitle: 'Gateway endpoint',
    openClawGatewayPlaceholder: 'ws://127.0.0.1:8042',
    openClawGatewayConfigured: 'Configured: {endpoint}',
    openClawGatewayNotConfigured: 'No Gateway endpoint configured yet.',
    openClawConflictTitle: 'Concurrent file change detected',
    openClawConflictDismiss: 'Dismiss warning',
    openClawRuntimeErrorTitle: 'OpenClaw runtime error',
    openClawAttach: 'Attach workspace',
    openClawDetach: 'Detach workspace',
    openClawOpenAgents: 'Open AGENTS.md',
    openClawOpenTodayMemory: 'Open today memory',
    cloudRelayTitle: 'Cloud Relay',
    cloudRelayDesc: 'Use Cloud Relay to connect your phone when it is on a different network.',
...
5) Keep it concise, bullet-style, in English`,
  ...
  imageManager: {
    ...
    title: 'Image Manager',
    description: 'Browse every image in the vault, see which notes depend on it, and safely rename or move files without breaking Markdown references.',
    ...
    badgeLarge: 'Large',
    // Messages
    orphanOnlyWarning: 'This view currently only shows orphaned images. These files are not referenced by any note and are good cleanup candidates.',
    ...
    emptyVaultDescription: 'The image manager reads directly from the current workspace and shows every image file that lives inside it.',
    scanningTitle: 'Scanning images',
    scanningDescription: 'Building relationships between image files and the notes that reference them.',
    noImagesTitle: 'No images in this vault',
    noImagesDescription: 'Paste or add images to any note, and they will appear here with note references and management actions.',
    noMatchTitle: 'No matching images',
    noMatchDescription: 'Try a different search, status filter, or folder scope.',
    selectImageTitle: 'Select an image',
    selectImageDescription: 'Use the grid, list, or grouped view to inspect a file and see its note relationships here.',
    // List view columns
    ...
    noReferencesWarning: 'No note currently references this image. It is safe to review, rename, move, or clean up.',
    // Multi-selection panel
    batchActions: 'Batch actions',
    batchSummary: '{orphanCount} orphaned, {multiCount} multi-referenced, total size {totalSize}.',
    moveSelectedSafely: 'Move selected safely',
    // Action dialog
    renameImageSafely: 'Rename image safely',
    moveImagesSafely: 'Move {count} image(s) safely',
    renameDescription: 'Lumina will rename the image file and rewrite every affected Markdown reference before it leaves this dialog.',
    moveDescription: 'Lumina will move the image files into the target folder and update every affected Markdown reference in one operation.',
    ...
    noNoteReferencesNeedChange: 'No note references need to change for this action.',
